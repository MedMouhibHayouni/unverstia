  ...
  async create(
    ...
    if (!major) {
      throw new BadRequestException(
        `Major with ID ${createDegreeProgramDto.major_id} not found`,
      );
    }
    ...
    if (!speciality) {
      throw new BadRequestException(
        `Speciality with ID ${createDegreeProgramDto.speciality_id} not found`,
      );
    }
    ...
    if (!institution) {
      throw new BadRequestException(
        `Institution with ID ${createDegreeProgramDto.institution_id} not found`,
      );
    }
